...
<head>
  <title>Home Decor -By Poonam</title>
  <meta charset="utf-8" />
...
<body>
  ...
  <nav class="navbar navbar-default" role="navigation">
    <div class="container" style="display:flex;">
      <div class="navbar-header" style="margin-right:20rem">
        ...
        <!-- Logo text or image -->
        <a class="navbar-brand" href="index.html">Home Decor</a>
      </div>
      <div class="navigation collapse navbar-collapse navbar-ex1-collapse">
        ...
        <div><ul class="nav navbar-nav"><li><a style="color:#f1f1f1; font-size:16px" class ="navbar-brand"  href="/login.php">Show Users</a></li></ul></div>
      <div class="dropdown">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-offset-2 col-md-8">
          <div class="section-heading">
            ...
            <p>
              We are providing services for Home Decorations for past 6 years.
            </p>
          </div>
        </div>
      </div>
      <div class="row wow fadeInUp">
        ...
        <div class="col-md-6 content">
          <h2>
            Experts interior decorators are there to help you guide to your dream home interiors.
          </h2>
          <h3>
            We believe that design is a tool used to create a strong and lasting impact. That is why our products are unique, functional, and carefully crafted, blending traditional craftsmanship with modern style
          </h3>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="color-light">
            <h2 class="wow bounceInDown" data-wow-delay="0.5s">
            ...
            <div class="carousel-inner">
                ...
                <div class="row">
                  <div class="col-sm-12 col-md-offset-1 col-md-6">
                    <div class="wow bounceInLeft">
                      <h4>Wall paper</h4>
                      <p>
                        Get the walls designed by our experts.
                      </p>
                    </div>
                  </div>
                  <div class="col-sm-12 col-md-5">
                    <div class="screenshot wow bounceInRight">
                      <img src="img/screenshots/wall-image.jpg" class="img-responsive" alt="" />
                    </div>
                  </div>
                </div>
              </div>
              <div class="item">
                <div class="row">
                  <div class="col-sm-12 col-md-offset-1 col-md-6">
                    <div class="wow bounceInLeft">
                      <h4>Texture Wall Backgrounds</h4>
                      <p>
                        Get the textured walls designed by our experts.
                      </p>
                    </div>
                  </div>
                  <div class="col-sm-12 col-md-5">
                    <div class="screenshot wow bounceInRight">
                      <img src="img/screenshots/texture-wall.jpeg" class="img-responsive" alt="" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                  <div class="col-sm-12 col-md-offset-1 col-md-6">
                    <div class="wow bounceInLeft">
                      ...
                      <p>
                        Get your Kitchen decorated from our experts.
                      </p>
                    </div>
                  </div>
                  <div class="col-sm-12 col-md-5">
                    <div class="screenshot wow bounceInRight">
                      <img src="img/screenshots/kitchen-renovation.jpeg" class="img-responsive" alt="" />
                    </div>
                  </div>
                </div>
              </div>
          ...
          <ul id="og-grid" class="og-grid">
            ...
            <li>
              <a href="#" data-largesrc="img/works/4.jpg" data-title="Portfolio title" data-description="In mentitum forensibus nec, nibh eripuit ut pri, tale illud voluptatum ut sea. Sed oratio repudiare ei, cum an magna labitur, eu atqui augue mei. Pri consul detracto eu, solet nusquam accusam ex vim, an movet interesset necessitatibus mea.">
                <img src="img/works/thumbs/4.jpeg" alt="img01" />
              </a>
            </li>
            <li>
              <a href="#" data-largesrc="img/works/5.jpg" data-title="Portfolio title" data-description="Duo te dico volutpat, unum elit oblique per id. Ne duo mollis sapientem intellegebat. Per at augue vidisse percipit, pri vocibus assueverit interesset ut, no dolore luptatum incorrupte nec. In mentitum forensibus nec, nibh eripuit ut pri, tale illud voluptatum ut sea">
                <img src="img/works/thumbs/5.jpeg" alt="img01" />
              </a>
            </li>
            <li>
              <a href="#" data-largesrc="img/works/6.jpg" data-title="Portfolio title" data-description="Id elit saepe pro. In atomorum constituam definitionem quo, at torquatos sadipscing eum, ut eum wisi meis mentitum. Probo feugiat ea duo. An usu platonem instructior, qui dolores inciderint ad. Te elit essent mea, vim ne atqui legimus invenire, ad dolor vitae sea.">
                <img src="img/works/thumbs/6.jpeg" alt="img01" />
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="#" data-largesrc="img/works/9.jpg" data-title="Portfolio title" data-description="Lorem ipsum dolor sit amet, ex pri quod ferri fastidii. Mazim philosophia eum ad, facilisis laboramus te est. Eam magna fabellas ut. Ne vis diceret accumsan salutandi, pro in impedit accusamus dissentias, ut nonumy eloquentiam ius.">
                <img src="img/works/thumbs/9.jpeg" alt="img01" />
              </a>
            </li>
            <li>
              <a href="#" data-largesrc="img/works/10.jpg" data-title="Portfolio title" data-description="Duo te dico volutpat, unum elit oblique per id. Ne duo mollis sapientem intellegebat. Per at augue vidisse percipit, pri vocibus assueverit interesset ut, no dolore luptatum incorrupte nec. In mentitum forensibus nec, nibh eripuit ut pri, tale illud voluptatum ut sea. Sed oratio repudiare ei, cum an magna labitur, eu atqui augue mei. Pri consul detracto eu, solet nusquam accusam ex vim.">
                <img src="img/works/thumbs/10.jpeg" alt="img01" />
              </a>
            </li>
            <li>
              <a href="#" data-largesrc="img/works/11.jpg" data-title="Portfolio title" data-description="Vim ad persecuti appellantur. Eam ignota deterruisset eu, in omnis fierent convenire sed. Ne nulla veritus vel, liber euripidis in eos. Postea comprehensam vis in, detracto deseruisse mei ea. Ex sadipscing deterruisset concludaturque quo.">
                <img src="img/works/thumbs/11.jpeg" alt="img01" />
              </a>
            </li>
            <!-- <li>
                <a
      ...
      <div class="row">
        <div class="col-md-offset-2 col-md-8">
          <div class="section-heading">
            ...
            <div class="heading-line"></div>
            <p>
              If you have any question or just want to say 'hello' to Home Decor please fill out form below and we will be get in
      ...
      <div class="row">
        <div class="col-md-offset-2 col-md-8">
          <div class="section-heading">
            ...
            <div class="heading-line"></div>
            <p>
              We will be expanding our team soon in California.
            </p></br>
            <p>
              We are excited to launch 15% discount in June 2021.
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="contact-widget wow bounceInLeft">
            ...
            fclose($myfile);
            ?>
            <p id="address"> <?php echo $array[0] ?> <br /><?php echo $array[1] ?> </p>
        ...
        <div class="col-md-4">
          <div class="contact-widget wow bounceInRight">
            ...
            <h5>Email us</h5>
            <p><?php echo $array[4] ?><br /><?php echo $array[5] ?></p>
          </div>
        </div>
      </div>
          ...
          <ul class="social-network">
            ...
            <li>
              <a href="#">
                <span class="fa-stack fa-2x">
                  <i class="fa fa-circle fa-stack-2x"></i>
                  <i class="fa fa-dribbble fa-stack-1x fa-inverse"></i> </span></a>
            </li>
            <li>
              <a href="#">
                <span class="fa-stack fa-2x">
            ...
            <li>
              <a href="#">
                <span class="fa-stack fa-2x">
                  <i class="fa fa-circle fa-stack-2x"></i>
                  <i class="fa fa-pinterest fa-stack-1x fa-inverse"></i> </span></a>
            </li>
          </ul>
        </div>
      </div>
